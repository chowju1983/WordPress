...
if (!class_exists('adg_custom_post_types')) {
    class adg_custom_post_types
    {
        ...
        public function init_admin_notices()
        {
            ...
            $fantastic_plugins_notice = get_option('fantastic_plugins_notices', false);

            if (!$fantastic_plugins_notice || time() > $fantastic_plugins_notice) { ?>
                <div class="notice notice-success is-dismissible">
                    <h3 style="text-transform: uppercase; margin-bottom: 0px;">⚡ <?php _e('Cool plugins - Try it now!', 'custom-post-types'); ?> ⚡</h3>
                    <p><?php _e('Here are other great plugins to customize and improve your website.', 'custom-post-types'); ?></p>
                    <ul>
                        <li>✅ <a href="https://wordpress.org/plugins/webp-images/" target="_blank" style="margin-left: 5px; font-weight: bold;"><?php _e('WebP Images', 'custom-post-types'); ?></a> <small>(<?php _e('speed up your website by converting images to webp format', 'custom-post-types'); ?>)</small></li>
                        <li>✅ <a href="https://wordpress.org/plugins/disable-unused-features/" target="_blank" style="margin-left: 5px; font-weight: bold;"><?php _e('Disable Unused Pages', 'custom-post-types'); ?></a> <small>(<?php _e('disable some default pages like author archives', 'custom-post-types'); ?>)</small></li>
                        <li>✅ <a href="https://wordpress.org/plugins/cloud-customer-area/" target="_blank" style="margin-left: 5px; font-weight: bold;"><?php _e('Cloud Customer Area', 'custom-post-types'); ?></a> <small>(<?php _e('exchange files with customers using Google Drive', 'custom-post-types'); ?>)</small></li>
                    </ul>
                    <p><?php _e('Don\'t forget to <u>leave your review</u>, special thanks from <strong>Andrea De Giovine</strong> ❤', 'custom-post-types'); ?></p>
                </div>
            <?php update_option('fantastic_plugins_notices', strtotime("+5 day", time()));
            }
            ...
            if (!isset($_COOKIE[$this->cpt_ui_name . '_notices_close'])) { ?>
                ...
                if (!$this->is_pro_version_active()) {
                    printf(
                        '<div class="%1$s"><p>%2$s<br><strong><a href="%3$s" target="_blank">%4$s</a></strong> - <a href="%5$s" target="_blank">%6$s</a> - <a href="%7$s" target="_blank">%8$s</a> - <a href="#" class="%9$s-notices-close">%10$s</a></p></div>',
                    ...
                    printf(
                        '<div class="%1$s"><p>%2$s<br><strong><a href="%3$s" target="_blank">%4$s</a></strong> - <a href="%5$s" target="_blank">%6$s</a> - <a href="#" class="%7$s-notices-close">%8$s</a></p></div>',
                        $this->cpt_ui_name . '-notices notice notice-success is-dismissible',
                        __('<strong>Custom post type</strong> notice:<br>Thanks for using this plugin! Do you want to help us grow to add new features?', 'custom-post-types'),
                        'https://wordpress.org/support/plugin/custom-post-types/reviews/#new-post',
                        __('Review', 'custom-post-types'),
                ...
                <script>
                    ...
                    jQuery(document).ready(function($) {
                        $(".<?php echo $this->cpt_ui_name; ?>-notices .<?php echo $this->cpt_ui_name; ?>-notices-close").click(function(e) {
                            e.preventDefault();
                            createCookie('<?php echo $this->cpt_ui_name; ?>_notices_close', 1, 5);
